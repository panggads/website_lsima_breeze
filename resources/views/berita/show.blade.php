<?php
    ...
    $coverUrl = $berita->cover ? asset('img/berita/' . $berita->cover) : null;
?>
...
<section class="mx-auto">
    <div class="ml-auto">
            <a href="{{ route('berita.index') }}" class="flex items-center justify-center px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-sky-600 rounded-lg shrink-0 w-36">
                ...
                <div class="mt-10">
                    <div class=" mt-4 pt-4 sm:mt-0 text-center sm:text-left">
                        ...
                        <div>
                            ...
                            <span class="text-slate-400 text-sm ml-6">Dilihat : {{ $berita->dibaca }} x</span>
                        </div>
                        <p class="leading-relaxed text-lg my-6">{!! $berita->isi !!}</p>
                    </div>
                </div>
            </div>
