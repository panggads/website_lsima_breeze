        ...
        <div class="container mx-auto relative px-6 py-3 lg:px-8">
            <nav class="flex items-center justify-between" aria-label="Global">
                ...
                <div class="hidden md:flex lg:gap-x-12">
                    ...
                    <a href="{{ route('allnews') }}" class="text-base font-semibold leading-6 text-gray-100 hover:text-gray-900 hover:bg-yellow-400 hover:rounded-lg py-1 px-3">Berita</a>
            
                    <a href="{{ route('profil') }}" class="text-base font-semibold leading-6 text-gray-100 hover:text-gray-900 hover:bg-yellow-400 hover:rounded-lg py-1 px-3">Profil</a>
            
                    <a href="{{ route('informasi') }}" class="text-base font-semibold leading-6 text-gray-100 hover:text-gray-900 hover:bg-yellow-400 hover:rounded-lg py-1 px-3">Informasi Publik</a>

                    <a href="#https://wbs.kemenkumham.go.id/index.php?r=site/main" class="text-base font-semibold leading-6 text-gray-100 hover:text-gray-900 hover:bg-yellow-400 hover:rounded-lg py-1 px-3">WBS</a>

                    <a href="{{ route('zi') }}" class="text-base font-semibold leading-6 text-gray-100 hover:text-gray-900 hover:bg-yellow-400 hover:rounded-lg py-1 px-3">ZI</a>
